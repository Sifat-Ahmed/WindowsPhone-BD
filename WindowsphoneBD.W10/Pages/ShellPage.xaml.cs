...
namespace WindowsphoneBD.Pages
{
    public sealed partial class ShellPage : Page
    {
        ...
        private void InitializeNavigationItems()
        {
            ...
            NavigationItems.Add(AppNavigation.NodeFromAction(
				"a04a9153-df82-4398-9c88-6c0ca419cd22",
                "Latest on Windowsphone BD",                
                AppNavigation.ActionFromPage("LatestOnWindowsphoneBDListPage"),
				AppNavigation.IconFromGlyph("\ue12a")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"9bb5c57c-d6a9-4635-804d-10e63a3ab1f0",
                "YouTube",                
                AppNavigation.ActionFromPage("YouTubeListPage"),
				AppNavigation.IconFromGlyph("\ue173")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"18ec7610-97dc-44e9-86a6-3ec49a6f3720",
                "@WindowsInsider",                
                AppNavigation.ActionFromPage("WindowsInsiderListPage"),
				AppNavigation.IconFromGlyph("\ue134")));

            NavigationItems.Add(AppNavigation.NodeFromAction(
				"21996ff9-c110-4d20-ae57-53bc4d78dd65",
                "About Windowsphone BD",                
                AppNavigation.ActionFromPage("AboutWindowsphoneBDListPage"),
				AppNavigation.IconFromGlyph("\ue13d")));
